...
},{"./handler_photoswipe.js":4,"lazyloadjs":2}],4:[function(require,module,exports){
"use strict";var initPhotoSwipeFromDOM=function(e){function a(e,t){return e&&(t(e)?e:a(e.parentNode,t))}function t(e){(e=e||window.event).preventDefault?e.preventDefault():e.returnValue=!1;var e=e.target||e.srcElement,t=a(e,function(e){return e.tagName&&"FIGURE"===e.tagName.toUpperCase()});if(t){for(var n,e=t.parentNode,r=document.getElementsByClassName("thumb"),i=r.length,o=0,l=0;l<i;l++)if(1===r[l].nodeType){if(r[l]===t){n=o;break}o++}return 0<=n&&s(n,e),!1}}function s(e,t,n,r){var i,o=document.querySelectorAll(".pswp")[0],l=function(e){for(var t,n,r,i=(e=e.parentNode.parentNode).getElementsByClassName("thumb"),o=i.length,l=[],a=0;a<o;a++)1===(t=i[a]).nodeType&&(r=(n=t.children[0]).getAttribute("data-size").split("x"),r={src:n.getAttribute("href"),w:parseInt(r[0],10),h:parseInt(r[1],10)},1<t.children.length&&(r.title=t.children[1].innerHTML),0<n.children.length&&(r.msrc=n.children[0].getAttribute("src")),r.el=t,l.push(r));return l}(t);if(console.log("--openPhotoSwipe--"),console.log(l),console.log(t),i={galleryUID:t.getAttribute("data-pswp-uid"),getThumbBoundsFn:function(e){var t=l[e].el.getElementsByTagName("img")[0],n=window.pageYOffset||document.documentElement.scrollTop,e=t.getBoundingClientRect();return console.log("--getThumbBoundsFn--"),console.log(t),{x:e.left,y:e.top+n,w:e.width}}},r)if(i.galleryPIDs){for(var a=0;a<l.length;a++)if(l[a].pid==e){i.index=a;break}}else i.index=parseInt(e,10)-1;else i.index=parseInt(e,10);isNaN(i.index)||(n&&(i.showAnimationDuration=0),new PhotoSwipe(o,PhotoSwipeUI_Default,l,i).init())}for(var n=document.querySelectorAll(e),r=0,i=n.length;r<i;r++)n[r].setAttribute("data-pswp-uid",r+1),n[r].onclick=t;e=function(){var e=window.location.hash.substring(1),t={};if(e.length<5)return t;for(var n,r=e.split("&"),i=0;i<r.length;i++)r[i]&&((n=r[i].split("=")).length<2||(t[n[0]]=n[1]));return t.gid&&(t.gid=parseInt(t.gid,10)),t}();e.pid&&e.gid&&s(e.pid,n[e.gid-1],!0,!0)},galleryClass="photos",selector="."+galleryClass,viewer={init:function(){initPhotoSwipeFromDOM(selector)}};module.exports={galleryClass:galleryClass,viewer:viewer};
},{}]},{},[3]);
