"use strict";require("lazyloadjs");var dataJSON,photoswipe=require("./handler_photoswipe.js"),view=_interopRequireDefault(photoswipe.viewer),galleryPath=window.location.pathname,galleryName=galleryPath.split("/")[2],dataUrl="/album/"+galleryName+"/data.json";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var render=function(e){var a,t=e.image_bed,i=e.description,r="";for(a of e.items){var s,o="",l=a.date,n=l.split("-")[0],l=l.split("-")[1];for(s of a.images){var d=t+"/"+galleryName+"/thumbnail/"+s.name,p=t+"/"+galleryName+"/artwork/"+s.name,c=s.caption,m=s.address;o+=`
